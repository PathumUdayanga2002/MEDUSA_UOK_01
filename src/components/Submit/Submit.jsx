        ...
        <div className=" md:flex md:flex-row flex flex-col space-y-4 md:justify-between mb-4">
          ...
          <div>
            ...
            <p className="md:text-xl text-lg max-w-2xl mb-5">
              If you want to register MEDUSA CTF 2024, you must find the Secret
              Key In Below task...!!
            </p>
            </div>
            <div className="flex flex-col gap-4 md:mt-10">
              <div>
              <input
                className=" border-2 border-green-400  md:w-[300px] md:h-[50px] w-[325px] h-[50px] rounded-xl p-4 text-black "
                type="text"
